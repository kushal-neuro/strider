...
1. [Setup - The basics of getting started with strider](#setup)
    * [What strider affects](#what-strider-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with strider](#beginning-with-strider)
